Trestle.configure do |config|
  ...
  #
  config.site_title = "Fitness Apps"
  ...
  #
  config.footer = "Powered by Trestle/Rails/Devise"
  ...
  #
  # zafor config.auth.user_admin = -> { :"auth/account" }

  config.auth.user_scope = -> { User }
  config.auth.user_admin = -> { Trestle.config.auth.user_class }
