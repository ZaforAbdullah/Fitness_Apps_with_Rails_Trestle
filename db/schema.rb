...
ActiveRecord::Schema[7.1].define(version: 2024_05_22_183010) do
  ...
  create_table "nutrition_logs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "meal_type"
    t.text "description"
    t.integer "calories"
